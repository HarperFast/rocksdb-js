	...
	'targets': [
		{
			...
			'sources': [
				...
				'src/binding/core/local_stamp.cpp',
				...
				'src/binding/database/local_stamp_state.cpp',
		...
		},
		{
			...
			'sources': [
				...
				'test/native/local_stamp_test.cc',
				'test/native/platform_fd_limit_test.cc',
				'test/native/restamp_rebuild_test.cc',
			...
			'defines': [
				...
				'ROCKSDB_JS_FTRUNCATE=rocksdb_js_mock_ftruncate',
