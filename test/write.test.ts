...
describe('Write operations', () => {
	describe('put()', () => {
		it('should set and get a value using default column family', () =>
			dbRunner(async ({ db }) => {
		...
		it('should set and get a value using custom column family', () =>
		...
		it('should throw an error if database is closed', () =>
			dbRunner(async ({ db }) => {
				await db.close();
	...
	describe('remove()', () => {
		it('should not error if removing a non-existent key', () =>
			dbRunner(async ({ db }) => {
				await db.remove('baz');
			}));
