...
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| `columnFamily.pendingReclaims`              | Number of dropped column families of this database whose physical `DropColumnFamily` has not completed: a commit admitted before the drop still holds it, or the drop failed and is retried on the next drop, open of that name, or close (see "Dropping column families" in the README). | gauge  |
