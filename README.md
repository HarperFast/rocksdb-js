...
The transaction ID, an integer in `[1, Number.MAX_SAFE_INTEGER]`. Transaction IDs are unique to
the RocksDB database path, regardless the database name/column family.
