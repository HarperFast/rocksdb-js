...
export type StatsAllExtras = {
	...
	'rocksdb.wal.precreate.hit': number;
	'rocksdb.wal.precreate.miss': number;
	'rocksdb.wal.precreate.waited': number;
	'rocksdb.wal.precreate.wait.micros': number;
	'rocksdb.wal.precreate.failed': number;
	'rocksdb.rate.limiter.bytes.read': number;
	'rocksdb.rate.limiter.bytes.write': number;
	'rocksdb.rate.limiter.requests.read': number;
	'rocksdb.rate.limiter.requests.write': number;
	'rocksdb.rate.limiter.delayed.requests.read': number;
	'rocksdb.rate.limiter.delayed.requests.write': number;
	'rocksdb.rate.limiter.total.wait.micros.read': number;
	'rocksdb.rate.limiter.total.wait.micros.write': number;
	'rocksdb.read.path.range.tombstones.inserted': number;
	'rocksdb.read.path.range.tombstones.discarded': number;
	'rocksdb.file.open.metadata.retrieved': number;
	'rocksdb.file.open.metadata.passed': number;
	'rocksdb.manifest.validation.failure.count': number;
	'rocksdb.flush.reason.write_buffer_full': number;
	'rocksdb.flush.reason.write_buffer_manager': number;
	'rocksdb.flush.reason.memtable_max_range_deletions': number;
	'rocksdb.atomic_flush.request.reason.write_buffer_full': number;
	'rocksdb.atomic_flush.request.reason.write_buffer_manager': number;
	'rocksdb.atomic_flush.request.reason.memtable_max_range_deletions': number;
	'rocksdb.atomic_flush.request.reason.other': number;
	'rocksdb.checkpoint.read.bytes': number;
	'rocksdb.checkpoint.write.bytes': number;
	'rocksdb.file.submit.async.read.fallback': number;
	...
	'rocksdb.ingest.external.file.prepare.micros': StatsHistogramData;
	'rocksdb.ingest.external.file.run.micros': StatsHistogramData;
	'rocksdb.iodispatcher.async.read.observed.completion.micros': StatsHistogramData;
	'rocksdb.iodispatcher.async.read.poll.wait.micros': StatsHistogramData;
	'rocksdb.iodispatcher.async.read.prefetch.lead.micros': StatsHistogramData;
	'rocksdb.rate.limiter.wait.micros.read': StatsHistogramData;
	'rocksdb.rate.limiter.wait.micros.write': StatsHistogramData;
	'rocksdb.flush.memtable.memory.bytes': StatsHistogramData;
	'rocksdb.flush.memtable.total.data.size.bytes': StatsHistogramData;
	'rocksdb.flush.write_buffer_full.memtable.memory.bytes': StatsHistogramData;
	'rocksdb.flush.write_buffer_manager.memtable.memory.bytes': StatsHistogramData;
	'rocksdb.open.and.compact.db.open.micros': StatsHistogramData;
};
